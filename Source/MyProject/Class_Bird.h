...
#include "Class_Bird.generated.h"

UCLASS()
class MYPROJECT_API AClass_Bird : public APawn
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Jump Components") FVector JumpStrength = FVector(0.f, 0.f, 100.f);
	void Jump();
};
